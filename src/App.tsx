...
const GlayScale = (c1: Color) => {
  const y = 0.299 * c1.r + 0.587 * c1.g + 0.114 * c1.b;
  return {
    r: y,
    g: y,
    b: y
...
export default function App() {
  ...
  const draw = (p: p5Types) => {
    ...
    const resultColor = ReverseMathColor(GlayScale(MathColor(data[0].Color1)));
    ...
    p.textSize(p.width / 20);
    p.text("→", GetPositionFromColumn(p, 5), p.height / 2);
  };
  return (
    <div className="App">
